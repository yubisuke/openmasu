...
class OpenMasuMaxRevenueListener(
  private val sdk: OpenMasuSdk,
...
object OpenMasuMaxBridge {
  @JvmStatic
  fun listener(sdk: OpenMasuSdk): OpenMasuMaxRevenueListener =
    OpenMasuMaxRevenueListener(sdk, MaxRevenueMapper(sdk::installationIdForMeasurement))
