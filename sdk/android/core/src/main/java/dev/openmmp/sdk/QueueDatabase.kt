...
abstract class OpenMmpQueueDatabase : RoomDatabase() {
  abstract fun queue(): QueueDao

  companion object {
    fun open(context: Context): OpenMmpQueueDatabase {
      val subtree = File(context.filesDir, OpenMmpStorage.SUBTREE).apply { mkdirs() }
      return Room.databaseBuilder(
        context.applicationContext,
        OpenMmpQueueDatabase::class.java,
