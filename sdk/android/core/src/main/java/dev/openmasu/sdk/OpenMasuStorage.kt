...
internal class OpenMasuStorage(context: Context) {
  ...
  fun persistConfiguration(configuration: OpenMasuConfiguration) {
    preferences.edit()
  ...
  fun configuration(): OpenMasuConfiguration? {
  ...
  companion object {
    ...
    const val SDK_VERSION = "0.2.0-rc.3"
