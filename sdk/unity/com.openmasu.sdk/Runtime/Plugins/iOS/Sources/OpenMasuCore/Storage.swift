...
public final class OpenMasuStorage: @unchecked Sendable {
  public static let directoryName = "OpenMasuSDK"
  ...
  public init(root: URL? = nil) throws {
    ...
    else { throw OpenMasuError.storage("queue_open_failed") }
  ...
  private func databaseError(_ prefix: String) -> OpenMasuError {
    let detail = database.flatMap(sqlite3_errmsg).map { String(cString: $0) } ?? "unknown"
    return OpenMasuError.storage("\(prefix):\(detail)")
  }
}
