...
- The next milestone is M1a Shadow ledger and import foundation. M1b adds cohort metrics and difference audit, followed by the non-code M1.5 Continuation decision gate. Do not start M2+ scope out of order without checking `docs/roadmap.md` first.
