...
- R-27 adds D30/D90 purchase-net revenue and the independent `total_net_revenue` numerator. Total-net revenue is advertising revenue plus settled installation-anchored purchases minus admitted settled refunds; existing ad-only definitions are unchanged.
