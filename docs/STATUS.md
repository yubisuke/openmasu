...
| M4a iOS first-party | Implemented | Swift SDK, protected excluded queue with restart-persistent consent admission barrier, AdServices handoff, MAX revenue mapping, Unity iOS source bridge, simulator/build/SBOM gates | Real Apple Ads, App Store review, device backup/transfer, live MAX, and Unity Xcode export remain open |
