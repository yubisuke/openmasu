...
- [AppLovin MAX Unity advanced settings](https://developers.applovin.com/en/max/unity/overview/advanced-settings/), [Android advanced settings](https://developers.applovin.com/en/max/android/overview/advanced-settings/), [iOS advanced settings](https://developers.applovin.com/en/max/ios/overview/advanced-settings/), and the [pinned 13.6.4 Swift Package manifest](https://raw.githubusercontent.com/AppLovin/AppLovin-MAX-Swift-Package/13.6.4/Package.swift) define the impression-revenue fields, ad-format evidence, and exact compile-only provider dependency. The three advanced-settings pages were checked on 2026-08-30.
