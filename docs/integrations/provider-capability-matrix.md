...
| AdAttributionKit | Signed developer-copy receiver; install and re-engagement aggregate series; iOS conversion-type/tag helpers | Synthetic JWS fixture, receiver/replay tests, TypeScript/Python/PostgreSQL parity, macOS SDK gate | Real copies, Info.plist propagation, device conversion windows, caller-owned conversion-tag lifecycle |
